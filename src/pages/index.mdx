...
## Core Contributions
A systematic study of three
LLMs for zero-shot unit test generation for 194 classes from 47
open-source projects in the SF110 dataset and 160 classes from
...
A discussion about the implication of using code generation models
for unit test generation in a Test Driven Development (TDD) environment.
